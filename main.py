...
def main():
    ...
    if mejor_valido:
        ...
        if mejor_valido in placas_robadas:
            ...
            # ============================
            # REGISTRAR EVENTO SOLO SI
            # API CONFIRMA ROBO
            # ============================
            
            if respuesta is not None:
            
                if "robado" in respuesta:
            
                    if respuesta["robado"] == True:
